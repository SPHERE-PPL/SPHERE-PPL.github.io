...
::: {layout="[30,70]"}
![](images/alex-rabeau.jpeg)

### Dr Alex Rabeau

Dr Alex Rabeau is a postdoctoral researcher at Imperial College London and the Alan Turing Institute. His PhD research focused on modelling the impacts of climate change on ecosystems using fine-scale ecological niche modelling and trait-based approaches. At the Turing Institute, he coordinates the SPHERE-PPL forecasting contests, which aim to advance the application of AI-driven forecasting methods to environmental and health challenges.
:::
